...
class DomainVerificationTest extends TestCase
{
    ...
    /** 
  @var DomainVerification $subject; 
**/ 
 protected $subject;
    ...
    public static function domainVerificationValidDataProvider()
    {
        return [
     ...
     * @return void
     */
    public function testGetProviderValidProviders($txt,  $expectedProvider)
    {
     ...
     * @return array[]
     */
    public static function domainVerificationValidDataValuesProvider()
    {
        return [
     ...
     * @return void
     */
    public function testGetProviderValidProvidersValues($txt,  $expectedValue)
    {
