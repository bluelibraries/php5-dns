...
namespace BlueLibraries\PHP5\Dns\Test\Unit\Facade;

use BlueLibraries\PHP5\Dns\Facade\Record;
...
class RecordTest extends TestCase
{
     ...
     * @return array[]
     */
    public static function fromNormalizedArrayDataProvider()
    {
        return [
            [
                [],
     ...
     */
    public function testFromNormalizedArray(array $array, $expected)
    {
